...
export const brandAssets = {
  ...
  "tgl": {
    assets: [
      { name:"병아리콩 건면", icon:"🌾", desc:"병아리콩 원료 자체가 대형 관심 카테고리 🌱 자연 비건/식물성 — 별도 비건 인증 없이도 원료 자체가 식물성", keywords:["병아리콩","병아리콩 효능","병아리콩 요리"], totalVolume:137819, topKeyword:{kw:"병아리콩",vol:73993} },
      { name:"단백질 15g", icon:"💪", desc:"면 제품에서 단백질 15g은 차별화 자산", keywords:["단백질 면","단백질 라면","단백질 많은 음식"], totalVolume:27406, topKeyword:{kw:"단백질 많은 음식",vol:26873} },
      { name:"다이어트 면 대안", icon:"🥗", desc:"다이어트 중 면 욕구를 해결하는 포지셔닝", keywords:["다이어트 간식","다이어트 면","다이어트 라면","다이어트 중 라면","다이어트 파스타","콩담백면"], totalVolume:67232, topKeyword:{kw:"다이어트 간식",vol:36896}, pathfinderNote:"'다이어트 면' → '콩담백면'(월 10,783회) 여정에 탱글 부재 — 삽입 기회" },
      { name:"4분 간편 조리", icon:"⏱️", desc:"운동 후/바쁜 일상에서 빠른 단백질 섭취", keywords:["운동 후 식사","운동 후 라면"], totalVolume:2964, topKeyword:{kw:"운동 후 식사",vol:2686}, pathfinderNote:"'운동 후 식사추천' → '운동 후 라면' 경로 실제 존재(월 278회)" },
      // ── 신규 자산 5개 (캠페인 확장) ──
      { name:"프로틴 파스타", icon:"🍝", desc:"다이어트 중 파스타 욕구를 프로틴으로 해결", keywords:["다이어트 파스타","파스타 다이어트","단백질 파스타","프로틴 파스타","탱글 파스타 다이어트"], totalVolume:15834, topKeyword:{kw:"다이어트 파스타",vol:9980}, pathfinderNote:"★ 가장 큰 진입점. 탱글 파스타 다이어트 98/mo. 브랜드 검색 안정화" },
      { name:"직장인 점심 대용", icon:"🏢", desc:"오피스 런치타임에 간편하게 한끼 해결", keywords:["직장인 점심 도시락","점심 대용","점심 간편식","회사 점심 메뉴 추천","한끼대용"], totalVolume:6575, topKeyword:{kw:"직장인 점심 도시락",vol:2450}, pathfinderNote:"★ 브리프 직결. 런치타임 오피스 샘플링과 연계. 구매 인텐트(T) 키워드 다수." },
      { name:"단백질 간식/보상", icon:"🏋️", desc:"프로틴 파우더 피로감 탈출, 음식으로 단백질", keywords:["단백질 간식","프로틴 간식","단백질 간식 추천"], totalVolume:6146, topKeyword:{kw:"단백질 간식",vol:5723}, pathfinderNote:"남성 세그먼트 기회. +78% 급성장." },
      { name:"운동 후 단백질 보충", icon:"💪", desc:"운동 후 식사로 파스타+단백질 조합", keywords:["운동 후 식사","운동 후 식사 추천"], totalVolume:2686, topKeyword:{kw:"운동 후 식사",vol:2686}, pathfinderNote:"브리프의 '운동 관심사' 타겟 직결. 여성 68.2%가 검색." },
      { name:"자취생 간단한 한끼", icon:"🏠", desc:"1인가구/자취생의 빠르고 건강한 한끼", keywords:["자취 한끼","간단한 한끼 요리","자취 간편식"], totalVolume:1294, topKeyword:{kw:"자취 한끼",vol:357}, pathfinderNote:"★ 최고 성장률 +49%. 1인가구 트렌드와 직결." },
      { name:"Meal-prep 식단 준비", icon:"📦", desc:"일요일 식단 준비에 탱글을 포함하는 루틴", keywords:["밀프렙","밀프랩","다이어트 밀프렙","단백질 도시락","식단 도시락","일주일 식단","일주일 도시락"], totalVolume:45590, topKeyword:{kw:"밀프랩",vol:20013}, pathfinderNote:"★ NEW — 가장 큰 규모의 새 오케이션. 밀프렙+밀프랩 합산 27,969/mo. +78% 급성장 (다이어트 밀프렙). 단백질 도시락은 구매 인텐트(T)." },
      // ── 신규 자산 3개 (Sections 10-12) ──
      { name:"혈당스파이크 대안", icon:"📊", desc:"병아리콩 건면 = 밀가루 없는 저GI 면. 혈당스파이크 걱정 없이 면을 먹는 법 (※ 의료 주장 금지, 라이프스타일 선택으로 접근)", keywords:["혈당스파이크","글루텐프리","밀가루 끊기","GI지수 낮은 음식","글루텐프리 파스타","병아리콩 혈당","밀가루 없는 면"], totalVolume:53347, topKeyword:{kw:"혈당스파이크",vol:37576}, pathfinderNote:"'혈당스파이크' 37,576/mo (-18% 피크 후 안정화, 여전히 탱글 관련 최대 키워드). 밀가루 대안 수요 지속. '글루텐프리' 11,093/mo. 반드시 '의학적 주장'이 아닌 '라이프스타일 선택'으로 접근" },
      { name:"야식 라면 대안", icon:"🌙", desc:"밤 11시, 라면 끓이는 대신 이걸 끓였습니다. 야식 면 욕구를 건강하게 해결", keywords:["다이어트 야식","야식 건강","건강한 야식","밤에 라면 대신"], totalVolume:8936, topKeyword:{kw:"다이어트 야식",vol:6736}, pathfinderNote:"'야식 추천' 21,856/mo → '다이어트 야식' 6,736/mo 경로. 야식 면 욕구에서 탱글이 건강한 대안으로 포지셔닝" },
      { name:"키즈 건강 면", icon:"👶", desc:"아이가 라면 달라고 할 때, 이걸 끓여주면 죄책감 없어요. 육아맘 타겟", keywords:["아이 간식","아이 건강 간식","키즈 간편식","아이 라면","아이 라면 대안"], totalVolume:7736, topKeyword:{kw:"아이 간식",vol:3376}, pathfinderNote:"육아맘 세그먼트 진입점. '아이 간식' 3,376/mo. 라면 대신 병아리콩 면이라는 죄책감 해소 포지셔닝" },
    ],
  },
  "pls": {
    assets: [
