...
export const keywordPool = [
  ...
  { kw: "파스타 다이어트", vol: 5180, trend: 0, brand: "tgl", tags: ["파스타","다이어트","건강","면"] },
  { kw: "편의점 파스타", vol: 1546, trend: -0.19, brand: "tgl", tags: ["편의점","파스타","유통","채널"] },
  { kw: "파스타 단백질", vol: 936, trend: 0, brand: "tgl", tags: ["파스타","단백질","영양","건강"] },
  { kw: "단백질 파스타", vol: 493, trend: -0.08, brand: "tgl", tags: ["단백질","파스타","건강","피트니스"] },
  { kw: "하이 프로틴 치킨면", vol: 150, trend: -0.97, brand: "tgl", tags: ["프로틴","치킨면","트렌드"] },
  { kw: "프로틴 파스타", vol: 116, trend: 0.08, brand: "tgl", tags: ["프로틴","파스타","구매","단백질"] },
  { kw: "탱글 파스타 다이어트", vol: 100, trend: 1.0, brand: "tgl", tags: ["탱글","파스타","다이어트","브랜드인지"] },
  ...
  { kw: "직장인 점심 도시락", vol: 2050, trend: 0.18, brand: "tgl", tags: ["직장인","점심","도시락","성장"] },
  { kw: "직장인 점심", vol: 1023, trend: -0.14, brand: "tgl", tags: ["직장인","점심","일상"] },
  ...
  { kw: "단백질 간식", vol: 4703, trend: 0.24, brand: "tgl", tags: ["단백질","간식","구매","성장"] },
  ...
  { kw: "혈당스파이크", vol: 40180, trend: 0.90, brand: "tgl", tags: ["혈당","스파이크","건강","급성장"] },
  { kw: "글루텐프리", vol: 10293, trend: 0.15, brand: "tgl", tags: ["글루텐프리","건강","알레르기"] },
  { kw: "밀가루 끊기", vol: 1563, trend: 0.20, brand: "tgl", tags: ["밀가루","끊기","건강","대체"] },
  ...
  { kw: "글루텐프리 파스타", vol: 680, trend: 0.25, brand: "tgl", tags: ["글루텐프리","파스타","대체"] },
  { kw: "병아리콩 혈당", vol: 456, trend: 0.15, brand: "tgl", tags: ["병아리콩","혈당","건강"] },
  { kw: "밀가루 대체", vol: 400, trend: 0.18, brand: "tgl", tags: ["밀가루","대체","건강"] },
  { kw: "글루텐프리 면", vol: 343, trend: 0.22, brand: "tgl", tags: ["글루텐프리","면","대체"] },
  ...
  // ═══ 탱글 확장 — 키즈 건강 면 키워드 (5) ═══
  { kw: "아이 간식", vol: 8500, trend: 0.10, brand: "tgl", tags: ["아이","간식","키즈","건강"] },
...
export const brandAssets = {
  ...
  "tgl": {
    assets: [
      { name:"병아리콩 건면", icon:"🌾", desc:"병아리콩 원료 자체가 대형 관심 카테고리 🌱 자연 비건/식물성 — 별도 비건 인증 없이도 원료 자체가 식물성", keywords:["병아리콩","병아리콩 효능","병아리콩 요리"], totalVolume:112009, topKeyword:{kw:"병아리콩",vol:59813} },
      ...
      { name:"혈당스파이크 대안", icon:"📊", desc:"병아리콩 건면 = 밀가루 없는 저GI 면. 혈당스파이크 걱정 없이 면을 먹는 법 (※ 의료 주장 금지, 라이프스타일 선택으로 접근)", keywords:["혈당스파이크","글루텐프리","밀가루 끊기","GI지수 낮은 음식","글루텐프리 파스타","병아리콩 혈당","밀가루 없는 면"], totalVolume:56156, topKeyword:{kw:"혈당스파이크",vol:40180}, pathfinderNote:"★ 10배 성장 키워드. '혈당스파이크' 40,180/mo (+90%). 밀가루 대안 수요 폭발. '글루텐프리' 10,293/mo. 반드시 '의학적 주장'이 아닌 '라이프스타일 선택'으로 접근" },
      ...
      { name:"키즈 건강 면", icon:"👶", desc:"아이가 라면 달라고 할 때, 이걸 끓여주면 죄책감 없어요. 육아맘 타겟", keywords:["아이 간식","아이 건강 간식","키즈 간편식","아이 라면","아이 라면 대안"], totalVolume:12860, topKeyword:{kw:"아이 간식",vol:8500}, pathfinderNote:"육아맘 세그먼트 진입점. '아이 간식' 8,500/mo. 라면 대신 병아리콩 면이라는 죄책감 해소 포지셔닝" },
    ],
  },
  "pls": {
    assets: [
