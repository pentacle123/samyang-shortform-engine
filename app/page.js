...
const shortformTypeData={
  ...
  consumerFormats:[
    ...
    {name:"정보형",icon:"📊",desc:"비교·과학·순위로 '알게 되는' 콘텐츠",consumerReaction:"저장·공유율 ↑",why:"새로운 정보 = 저장·공유 동기. 제품의 숨겨진 사실이 호기심을 자극",color:"#3b82f6",examples:["콩담백면 vs 탱글 영양성분 비교","매운 라면 순위 TOP5","우지파동의 진실"],samyangApp:"삼양1963 — 우지 과학, 탱글 — 콩담백면 비교, 맵탱 — 매운맛 순위",dataProof:"'콩담백면' 연 129,396회 검색 — 비교 콘텐츠의 소재가 데이터로 존재"},
...
const BRANDS=[
  ...
  {id:"buldak",nm:"불닭볶음면",em:"🔥",c:"#E63E00",cat:"US Market — Spicy Ramen",disabled:false,
    ...
    market:"us",
    tags:["Stress Relief","Spicy Kick","5 Min Meal","$2 Dinner","K-Food Icon","Hackable","Buldak Sauce","Shareable","Flavor World"],
  ...
  {id:"tgl",nm:"탱글",em:"🍝",c:"#16803C",cat:"건강한 면의 새 기준",disabled:false,def:"건강한 면의 새 기준.\n'라면 대신 탱글'이 모든 일상의 면 선택지에 들어간다.",str:"Lifestyle-hook",strL:"라이프스타일 어스피레이션",lv:"LOW",
    ...
    prof:{gen:"여성 81% · 남성 19%",age:"30대 32% · 25-29세 20.7%",ch:"온라인·편의점",chI:"🛒",persona:"다이어트 중 면이 먹고 싶은 2530 여성"},
    dp:["다이어트 면","단백질 식단","자취 간편식","편의점 신상"],cep:["💪 다이어트 면 → 건강식 맥락","🔬 단백질 파스타 → 기능 차별화","🏪 편의점 탱글 → 접근성"],strWhy:"'제품 소개'로 시작하면 스와이핑. '내 상황'에서 시작.",
    ctxGrid:[
      {label:"WHO",q:"누가 찾는가?",color:"#22c55e",tags:["다이어트 2530 여성","자취 1인가구","운동 직장인","건강식 탐색자","직장인 점심 여성 82.6%","프로틴 피로 남성 60.8%","혈당 관심층 +90%","육아맘"],ev:"여성 81.1% | 30대 31.6% · 25-29세 20.7% | '탱글 파스타' 연 73,272회 | '직장인 점심 도시락' 여성 83.0% · 30대 33.3% | '단백질 파스타' 남성 48.8% · 30대 48.8% — 남성 세그먼트 | '혈당스파이크' 37,576/mo -18% 피크 후 안정화 — 여전히 최대 키워드 | '아이 간식' 3,376/mo — 육아맘 세그먼트"},
      {label:"WHEN",q:"언제?",color:"#f59e0b",tags:["다이어트 중 면 욕구","운동 후","빠른 한 끼","직장인 점심시간","다이어트 중 파스타 욕구","밤 11시 야식","아이 라면 요청 시","혈당 관리 식사"],ev:"🔀 '운동 후 식사추천'→'운동 후 라면' 경로 존재!(연 3,336회) | '다이어트 중 라면 먹고 싶을때' 연 2,412회 — PAIN 검증됨 | '점심 간편식' +36% · '회사 점심 메뉴 추천' +40% 급성장 | '다이어트 파스타' 연 119,760회 | '다이어트 야식' 연 80,832회 — 야식 시간대 건강 면 수요 | '혈당스파이크' 연 450,912회 — 식사 시 혈당 관리 수요"},
      {label:"WHERE",q:"어디서?",color:"#3b82f6",tags:["편의점 파스타","쿠팡/컬리","건강식 SNS","오피스 런치타임","자취방 전자레인지","맘카페/육아 커뮤니티"],ev:"'편의점 신상' 연 173,400회 · 여성 80% · 30대 47% — 편의점 발견 채널 대형 | '직장인 점심 도시락' 연 29,400회 — 오피스 유통 기회 | '자취 한끼' +49% 최고 성장률 | 맘카페 — 육아맘 커뮤니티 입소문 채널"},
      {label:"PAIN",q:"어떤 불만?",color:"#ef4444",tags:["면=살찌는 죄책감","간편식 영양 부족","맛없는 다이어트식","프로틴 쉐이크 지겨움","점심 매번 고민","밀가루 면 혈당 걱정","야식 라면 죄책감","아이에게 라면 주는 죄책감"],ev:"🔗 '다이어트 라면' ClusterFinder: '다이어트 중 라면 먹고 싶을때' 연 2,412회 · '건면 다이어트' 연 6,516회 | 실제 경쟁자: 콩담백면 연 129,396회 · 여성 80.6% | '프로틴' 44,066/mo 중 100%가 파우더 → 음식형 프로틴 부재 | '다이어트 파스타' 연 119,760회 — 다이어트 면 욕구 검증 | '혈당스파이크' 37,576/mo -18% — 밀가루 면 자체가 PAIN (피크 후 안정화) | '다이어트 야식' 6,736/mo — 야식 라면 죄책감"},
      {label:"NEED",q:"어떤 욕구?",color:"#22c55e",tags:["죄책감 없는 면","건강한 한 끼","단백질 보충","파스타인데 프로틴","점심 대용 간편식","밀가루 없는 면","글루텐프리 대안","아이도 안심 면"],ev:"'단백질 간식' 연 68,676회 · 여성 61.3% · 30대 34.0% | 광고경쟁 HIGH — 시장 수요 검증 | '다이어트 파스타'+'파스타 다이어트' 합계 15,603/mo — 파스타 욕구가 더 큰 진입점 | '글루텐프리' 11,093/mo + '밀가루 끊기' 1,623/mo — 밀가루 대안 욕구 | '아이 건강 간식' 2,100/mo — 안심 먹이기 욕구"},
      {label:"INTEREST",q:"관심사?",color:"#a855f7",tags:["다이어트/건강식단","자취 브이로그","편의점 신상","운동 후 식사","직장인 브이로그","혈당 관리","글루텐프리 라이프","육아/키즈 건강"],ev:"'편의점 신상' 연 173,400회 + 상승세(+22% YoY) — Z세대 발견 콘텐츠 핵심 채널 | '운동 후 식사' 연 32,232회 · 여성 68.2% | '직장인 점심 도시락 메뉴' 여성 87.4% +19% 급성장 | '혈당스파이크' -18% — 피크 후 안정화, 여전히 최대 키워드 | '글루텐프리' 트렌드 확산"},
    ],
    ideas:[
      ...
      {score:91,psp:"B",type:"검색 여정 삽입",typeC:"#3b82f6",ctx:"경로: '다이어트 면' → '콩담백면'(연 129,396회) 분기점에 삽입",data:"🔀 PathFinder: '다이어트 면'→'콩담백면' 경로 압도적 | 📊 콩담백면 연 129,396회 · 여성 80.6% vs 탱글 5,840회/mo — 실제 경쟁자 확인 | '다이어트 중 라면 먹고 싶을때' 연 2,412회",hook:"\"콩담백면만 알고 있다면, 이걸 아직 모르는 겁니다\"",hookD:"대안형 — 다이어트 면 검색 시 콩담백면으로 흐르는 여정에 탱글을 삽입. 실제 경쟁자를 정면 겨냥",scenes:["다이어트 면 = 콩담백면?","콩담백면 한계 포인트","탱글 차별점 — 단백질 15g","시식 비교 반전"],
        shorts:sf("\"콩담백면만 알고 있다면\"","다이어트 면 = 콩담백면? 한 단계 위가 있습니다","대안형 후킹 — 콩담백면(연 129,396회)을 검색하는 소비자에게 '더 나은 선택지' 제시. 검색 여정 분기점 공략",["다이어트 면 하면 콩담백면 — 공감","'근데 단백질은?' — 콩담백면 한계","탱글 등장 — 병아리콩 건면 단백질 15g","동시 시식 비교 — 식감·단백질 차이"],"콩담백면 대비 단백질 함량 우위. 병아리콩 건면의 쫄깃한 식감 + 단백질 15g + 식이섬유 6g.","프로필 링크에서 주문 →",["#다이어트면","#콩담백면대안","#탱글","#단백질면","#다이어트라면"],"평일 오후","다이어트 면 탐색자, 콩담백면 경험자"),
  ...
  // ── 펄스랩 (compressed) ──
  {id:"pls",nm:"펄스랩",em:"🥜",c:"#7C3AED",cat:"식물성 단백질 스낵",disabled:false,def:"아무도 모르는 것이 무기.\n의외성으로 시청을 만들고, 시청으로 인지를 만든다.",str:"Discovery-hook",strL:"디스커버리 / 호기심 트리거",lv:"ZERO",
    ...
    <div style={{background:"#fff",borderRadius:14,padding:"20px 24px",border:"1px solid #f0f0f0",marginBottom:16}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
        ...
        <div style={{textAlign:"right"}}>
          ...
          <div style={{fontSize:9,color:"#999"}}>월 검색량{data.dataDate&&<span style={{marginLeft:4,fontWeight:700}}>({data.dataDate} 기준)</span>}</div>
        </div>
      </div>
      {data.brandSearchKeywords&&data.brandSearchKeywords.length>0&&<div style={{marginTop:14,paddingTop:14,borderTop:"1px dashed #e5e7eb"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8}}>
          <div style={{fontSize:9,fontWeight:800,color:"#666",letterSpacing:.5}}>🔍 연관 브랜드 검색어</div>
          <div style={{fontSize:9,color:"#999"}}>브랜드 검색 합계 <span style={{fontWeight:900,color:b.c}}>{data.brandSearchTotal.toLocaleString()}</span>/mo</div>
        </div>
        <div style={{display:"flex",flexWrap:"wrap",gap:"4px 10px"}}>
          {data.brandSearchKeywords.map((k,i)=>{
            const tColor=k.trend>0?"#16a34a":k.trend<0?"#dc2626":"#999";
            const tArrow=k.trend>0?"↑":k.trend<0?"↓":"→";
            const tPct=Math.round(k.trend*100);
            return <span key={i} style={{fontSize:9,color:"#555"}}>
              <span style={{fontWeight:700}}>{k.kw}</span>
              <span style={{marginLeft:3,color:"#888"}}>{k.vol.toLocaleString()}</span>
              <span style={{marginLeft:3,color:tColor,fontWeight:700}}>{tArrow}{tPct>=0?"+":""}{tPct}%</span>
              {i<data.brandSearchKeywords.length-1&&<span style={{marginLeft:6,color:"#ddd"}}>·</span>}
            </span>;
          })}
        </div>
      </div>}
      ...
      <div style={{background:"#fff",borderRadius:12,padding:"16px 18px",border:"1px solid #f0f0f0"}}>
        ...
        {b.market==="us"?<div>
          {Object.entries(data.profile).map(([k,v],i)=>{
            const labels={core:"핵심 소비자",multicultural:"다문화 세그먼트",brandSearch:"브랜드 검색",sauceGrowth:"소스 성장",topFlavor:"인기 맛",searchBehavior:"검색 행동",trendGrowth:"성장 추이"};
            const icons={core:"👤",multicultural:"🌎",brandSearch:"🔍",sauceGrowth:"📈",topFlavor:"🌶️",searchBehavior:"🔀",trendGrowth:"📊"};
            return <div key={i} style={{display:"flex",gap:8,marginBottom:8,alignItems:"flex-start"}}>
              <span style={{fontSize:10,flexShrink:0}}>{icons[k]||"•"}</span>
              <div><div style={{fontSize:8,color:"#999",fontWeight:600}}>{labels[k]||k}</div><div style={{fontSize:10,color:"#333",fontWeight:600}}>{v}</div></div>
            </div>;
          })}
        </div>:Object.entries(data.profile).map(([k,v],i)=>{
      ...
      <div style={{background:"#fff",borderRadius:14,padding:"20px 24px",border:"1px solid #f0f0f0",marginBottom:20}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:8}}>
          {top10.map((k,i)=>{
            ...
            // 변화량 뱃지 색상/아이콘
            let changeBg="#f3f4f6",changeFg="#9ca3af",changeIcon="—";
            if(k.isNew){changeBg="#fef3c7";changeFg="#a16207";changeIcon="★";}
            else if(k.change){
              const v=parseFloat(k.change.replace(/[+%]/g,""))||0;
              if(v>=10){changeBg="#dcfce7";changeFg="#16a34a";changeIcon="▲";}
              else if(v>0){changeBg="#ecfccb";changeFg="#65a30d";changeIcon="▲";}
              else if(v<=-10){changeBg="#fee2e2";changeFg="#dc2626";changeIcon="▼";}
              else if(v<0){changeBg="#ffedd5";changeFg="#ea580c";changeIcon="▼";}
            }
            return(
              ...
              <div style={{flex:1}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:3}}>
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:6}}>
                    ...
                    {k.change&&<span style={{fontSize:8,background:changeBg,color:changeFg,padding:"1px 5px",borderRadius:3,fontWeight:800}}>{changeIcon} {k.change}</span>}
...
★ YouTube Shorts 추가 필드 (shorts 안에 생성):
- textOverlays: 검색 최적화 텍스트 3개 (YouTube는 검색 플랫폼 → 텍스트 오버레이가 검색 노출에 직결). 예: "lazy dinner ideas", "buldak recipe hack", "5 min meal under $2"
- sound: 트렌딩 사운드 or 오리지널 ASMR 추천
- sharesTrigger: "send this to your broke friend who needs this" 같은 공유 유도
- saveTrigger: "save for your next lazy dinner night" 같은 저장 유도
- Shorts 목표 길이: 30~60초 (Shorts는 검색 유입이 많아 길어도 됨)

★ Instagram Reels 추가 필드 (reels 안에 생성):
- textOverlays: 감성/비주얼 텍스트 2~3개. 예: "stress level: 100", "$1.60 serotonin"
- sound: 트렌딩 오디오 필수 (IG는 트렌딩 오디오가 추천에 큰 영향)
- sharesTrigger: "tag someone who needs this after a bad day" 같은 태그 유도
- saveTrigger: "saving this for my next emotional breakdown" 같은 저장 유도
- loopPoint: Reels도 루프 효과 있음. 마지막→처음 연결 설명 (선택)
- Reels 목표 길이: 15~30초 (Reels는 짧을수록 유리)

★ 예산 배분: YouTube 30% (검색 유입+긴 수명) / Reels 30% (도달+트렌드) / TikTok 40% (핵심 채널, Spark Ads+니치+리추얼)`:""}
${b.id==="tgl"?`
★ 탱글 전용 톤 가이드:
...
- 광고 노출 타겟팅 (매우 중요): 각 아이디어에 adTargeting 필드를 추가해. 이 아이디어의 맥락 키워드와 인구통계에서 직접 추출.
  adTargeting: {
    ...
    reels: { interests: ["관심사 3~5개"], demo: "성별/연령", hashtags: ["#관련태그 5~8개"], campaignType: "도달 → 전환 최적화" },${b.market==="us"?`
    tiktok: { hashtags: ["#니치해시태그 5~7개"], interests: ["관심사 3~5개"], demo: "18-34세", niches: ["#니치커뮤니티 3개"], campaignType: "Spark Ads", campaignGoals: { awareness: "TopView/In-Feed", engagement: "Spark Ads", conversion: "TikTok Shop/Link in bio" } },`:""}
    budgetSplit: "${b.market==="us"?"YouTube 30% / Reels 30% / TikTok 40%":"YouTube 60% / Reels 40%"}",
...
[
  {
    ...
    "shorts": {
      ...
      "time": "업로드 최적시간",
      "cluster": "타깃 클러스터"${b.market==="us"?`,
      "textOverlays": ["검색 최적화 텍스트1 (SEO)", "텍스트2", "텍스트3"],
      "sound": "트렌딩 사운드 or 오리지널",
      "sharesTrigger": "공유 유도 문구 (send this to...)",
      "saveTrigger": "저장 유도 문구 (save for...)"`:``}
    },
    "reels": {
      "title": "릴스 제목",
      "hook": "릴스 후킹",
      ...
      "time": "업로드 최적시간",
      "cluster": "타깃 클러스터"${b.market==="us"?`,
      "textOverlays": ["감성/비주얼 텍스트1", "텍스트2"],
      "sound": "트렌딩 오디오 (Reels 핵심)",
      "sharesTrigger": "태그 유도 문구 (tag someone who...)",
      "saveTrigger": "저장 유도 문구 (saving this for...)",
      "loopPoint": "루프 연결 설명 (선택)"`:``}
    },
    ${b.market==="us"?`"tiktok": {
    ...
    "adTargeting": {
      ...
      "reels": { "interests": ["관심사1","관심사2","관심사3"], "demo": "성별 연령대", "hashtags": ["#태그1","#태그2","#태그3","#태그4","#태그5"], "campaignType": "도달 또는 전환 최적화" },${b.market==="us"?`
      "tiktok": { "hashtags": ["#니치해시태그1","#니치2","#니치3","#니치4","#니치5"], "interests": ["관심사1","관심사2","관심사3"], "demo": "18-34세", "niches": ["#StressTok","#BrokeTok","#CollegeTok"], "campaignType": "Spark Ads", "campaignGoals": { "awareness": "TopView/In-Feed", "engagement": "Spark Ads", "conversion": "TikTok Shop" } },`:""}
      "budgetSplit": "${b.market==="us"?"YouTube 30% / Reels 30% / TikTok 40%":"YouTube 60% / Reels 40%"}",
...
const AdTargetingSection=({idea,b})=>{
  ...
  const tk=ad?.tiktok||{hashtags:["#StressTok","#BrokeTok","#CollegeTok","#LateNightTok","#ComfortFood","#SpicyFood","#RamenTok"],interests:["Food & Beverage","Cooking","College Life","Stress & Mental Health","Budget Living"],demo:"18-34세",niches:["#StressTok","#BrokeTok","#CollegeTok"],campaignType:"Spark Ads (크리에이터 콘텐츠 부스팅)",campaignGoals:{awareness:"TopView / In-Feed Ads",engagement:"Spark Ads",conversion:"TikTok Shop / Link in bio"}};
  const budget=ad?.budgetSplit||(b.market==="us"?"YouTube 30% / Reels 30% / TikTok 40%":"YouTube 60% / Reels 40%");
  ...
  <div style={{marginTop:16}}>
    ...
    {open&&<div style={{background:"#fff",border:"1px solid #f0f0f0",borderTop:"none",borderRadius:"0 0 10px 10px",padding:20}}>
      <div style={{display:"grid",gridTemplateColumns:b.market==="us"?"1fr 1fr 1fr":"1fr 1fr",gap:16,marginBottom:16}}>
        {/* YouTube */}
        ...
        {/* TikTok Ads — 불닭 US 전용 */}
        {b.market==="us"&&<div style={{background:"#1a1a1a08",borderRadius:12,padding:16,border:"1px solid #e5e7eb"}}>
          <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:12}}>
            <span style={{fontSize:14}}>🎵</span>
            <span style={{fontSize:13,fontWeight:900}}>TikTok Ads</span>
          </div>
          <div style={{marginBottom:10}}>
            <div style={{fontSize:9,fontWeight:700,color:"#333",letterSpacing:1,marginBottom:4}}>맞춤 해시태그 타겟팅</div>
            <div style={{display:"flex",flexWrap:"wrap",gap:4}}>{(tk.hashtags||[]).map((k,i)=><span key={i} style={{background:"#1a1a1a",color:"#fff",padding:"3px 8px",borderRadius:4,fontSize:9}}>{k}</span>)}</div>
          </div>
          <div style={{marginBottom:10}}>
            <div style={{fontSize:9,fontWeight:700,color:"#333",letterSpacing:1,marginBottom:4}}>관심사 타겟팅</div>
            <div style={{display:"flex",flexWrap:"wrap",gap:4}}>{(tk.interests||[]).map((k,i)=><span key={i} style={{background:"#fff",border:"1px solid #d1d5db",color:"#333",padding:"3px 8px",borderRadius:4,fontSize:9}}>{k}</span>)}</div>
          </div>
          <div style={{marginBottom:10}}>
            <div style={{fontSize:9,fontWeight:700,color:"#333",letterSpacing:1,marginBottom:4}}>인구통계</div>
            <div style={{fontSize:10,color:"#444"}}>{tk.demo}</div>
          </div>
          <div style={{marginBottom:10}}>
            <div style={{fontSize:9,fontWeight:700,color:"#333",letterSpacing:1,marginBottom:4}}>니치 커뮤니티</div>
            <div style={{display:"flex",flexWrap:"wrap",gap:4}}>{(tk.niches||[]).map((k,i)=><span key={i} style={{background:"#dcfce7",color:"#16a34a",padding:"3px 8px",borderRadius:4,fontSize:9,fontWeight:700}}>{k}</span>)}</div>
            <div style={{fontSize:8,color:"#999",marginTop:4}}>니치 커뮤니티 타겟팅이 TikTok의 핵심 차별점</div>
          </div>
          <div style={{marginBottom:10}}>
            <div style={{fontSize:9,fontWeight:700,color:"#333",letterSpacing:1,marginBottom:4}}>캠페인 유형</div>
            <div style={{background:"#1a1a1a",borderRadius:6,padding:"6px 10px",fontSize:10,fontWeight:700,color:"#fff"}}>{tk.campaignType}</div>
          </div>
          {tk.campaignGoals&&<div>
            <div style={{fontSize:9,fontWeight:700,color:"#333",letterSpacing:1,marginBottom:4}}>캠페인 목표별 전략</div>
            <div style={{fontSize:9,color:"#555",lineHeight:1.8}}>
              <div>🔔 인지: {tk.campaignGoals.awareness}</div>
              <div>💬 참여: {tk.campaignGoals.engagement}</div>
              <div>🛒 전환: {tk.campaignGoals.conversion}</div>
            </div>
          </div>}
        </div>}
      </div>
...
<div style={{animation:"fi .4s"}}>
  ...
  <div style={{display:"grid",gridTemplateColumns:b.market==="us"?"1fr 1fr 1fr":"1fr 1fr",gap:16}}>
    ...
    <div style={{background:"#fff",borderRadius:16,border:"1px solid #f0f0f0",padding:"24px",overflow:"hidden"}}>
      ...
      {/* Shorts 추가 요소: 목표 길이 + TEXT OVERLAYS + SOUND + SHARE/SAVE */}
      {b.market==="us"&&<>
        <div style={{background:"#fef2f2",borderRadius:8,padding:"8px 14px",marginTop:12,border:"1px solid #fecaca",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          <span style={{fontSize:9,fontWeight:700,color:"#dc2626"}}>⏱ 목표 길이: 30~60초</span>
          <span style={{fontSize:8,color:"#999"}}>Shorts는 길어도 됨 (검색 유입)</span>
        </div>
        {idea.shorts.textOverlays&&<div style={{background:"#fef2f208",borderRadius:8,padding:"10px 14px",marginTop:8,border:"1px solid #fecaca"}}>
          <div style={{fontSize:9,fontWeight:700,color:"#dc2626",marginBottom:4}}>📝 TEXT OVERLAYS (SEO) ★★★</div>
          <div style={{fontSize:8,color:"#888",marginBottom:4}}>YouTube는 검색 플랫폼 — 텍스트 오버레이 = 검색 노출</div>
          <div style={{display:"flex",flexWrap:"wrap",gap:4}}>{idea.shorts.textOverlays.map((t,i)=><span key={i} style={{background:"#dc2626",color:"#fff",padding:"3px 8px",borderRadius:4,fontSize:8}}>{t}</span>)}</div>
        </div>}
        {idea.shorts.sound&&<div style={{background:"#faf5ff",borderRadius:8,padding:"10px 14px",marginTop:8,border:"1px solid #e9d5ff"}}>
          <div style={{fontSize:9,fontWeight:700,color:"#7c3aed",marginBottom:2}}>🎵 SOUND</div>
          <div style={{fontSize:9,color:"#666"}}>{idea.shorts.sound}</div>
        </div>}
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6,marginTop:8}}>
          {idea.shorts.sharesTrigger&&<div style={{background:"#eff6ff",borderRadius:6,padding:"8px 10px",border:"1px solid #dbeafe"}}>
            <div style={{fontSize:8,fontWeight:700,color:"#2563eb",marginBottom:2}}>📤 SHARE 트리거</div>
            <div style={{fontSize:8,color:"#555"}}>{idea.shorts.sharesTrigger}</div>
          </div>}
          {idea.shorts.saveTrigger&&<div style={{background:"#f0fdf4",borderRadius:6,padding:"8px 10px",border:"1px solid #dcfce7"}}>
            <div style={{fontSize:8,fontWeight:700,color:"#16a34a",marginBottom:2}}>🔖 SAVE 트리거</div>
            <div style={{fontSize:8,color:"#555"}}>{idea.shorts.saveTrigger}</div>
          </div>}
        </div>
      </>}
    ...
    <div style={{background:"#fff",borderRadius:16,border:"1px solid #f0f0f0",padding:"24px",overflow:"hidden"}}>
      ...
      {/* Reels 추가 요소: 목표 길이 + TEXT OVERLAYS + SOUND + SHARE/SAVE + LOOP */}
      {b.market==="us"&&<>
        <div style={{background:"#fdf2f8",borderRadius:8,padding:"8px 14px",marginTop:12,border:"1px solid #fbcfe8",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          <span style={{fontSize:9,fontWeight:700,color:"#db2777"}}>⏱ 목표 길이: 15~30초</span>
          <span style={{fontSize:8,color:"#999"}}>Reels는 짧을수록 유리</span>
        </div>
        {idea.reels.textOverlays&&<div style={{background:"#fdf2f808",borderRadius:8,padding:"10px 14px",marginTop:8,border:"1px solid #fbcfe8"}}>
          <div style={{fontSize:9,fontWeight:700,color:"#db2777",marginBottom:4}}>📝 TEXT OVERLAYS</div>
          <div style={{fontSize:8,color:"#888",marginBottom:4}}>검색보다는 감성/비주얼 텍스트</div>
          <div style={{display:"flex",flexWrap:"wrap",gap:4}}>{idea.reels.textOverlays.map((t,i)=><span key={i} style={{background:"#db2777",color:"#fff",padding:"3px 8px",borderRadius:4,fontSize:8}}>{t}</span>)}</div>
        </div>}
        {idea.reels.sound&&<div style={{background:"#faf5ff",borderRadius:8,padding:"10px 14px",marginTop:8,border:"1px solid #e9d5ff"}}>
          <div style={{fontSize:9,fontWeight:700,color:"#7c3aed",marginBottom:2}}>🎵 SOUND</div>
          <div style={{fontSize:8,color:"#888",marginBottom:2}}>트렌딩 오디오 필수 (Reels 핵심)</div>
          <div style={{fontSize:9,color:"#666"}}>{idea.reels.sound}</div>
        </div>}
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6,marginTop:8}}>
          {idea.reels.sharesTrigger&&<div style={{background:"#eff6ff",borderRadius:6,padding:"8px 10px",border:"1px solid #dbeafe"}}>
            <div style={{fontSize:8,fontWeight:700,color:"#2563eb",marginBottom:2}}>📤 SHARE 트리거</div>
            <div style={{fontSize:8,color:"#555"}}>{idea.reels.sharesTrigger}</div>
          </div>}
          {idea.reels.saveTrigger&&<div style={{background:"#f0fdf4",borderRadius:6,padding:"8px 10px",border:"1px solid #dcfce7"}}>
            <div style={{fontSize:8,fontWeight:700,color:"#16a34a",marginBottom:2}}>🔖 SAVE 트리거</div>
            <div style={{fontSize:8,color:"#555"}}>{idea.reels.saveTrigger}</div>
          </div>}
        </div>
        {idea.reels.loopPoint&&<div style={{background:"#fff7ed",borderRadius:8,padding:"10px 14px",marginTop:8,border:"1px solid #fed7aa"}}>
          <div style={{fontSize:9,fontWeight:700,color:"#ea580c",marginBottom:2}}>🔄 LOOP POINT</div>
          <div style={{fontSize:9,color:"#666"}}>{idea.reels.loopPoint}</div>
        </div>}
      </>}
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginTop:14,paddingTop:12,borderTop:"1px solid #f0f0f0"}}>
