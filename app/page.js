...
const BRANDS=[
  ...
  {id:"tgl",nm:"탱글",em:"🍝",c:"#16803C",cat:"건강한 면의 새 기준",disabled:false,def:"건강한 면의 새 기준.\n'라면 대신 탱글'이 모든 일상의 면 선택지에 들어간다.",str:"Lifestyle-hook",strL:"라이프스타일 어스피레이션",lv:"LOW",
    ...
    ctxGrid:[
      {label:"WHO",q:"누가 찾는가?",color:"#22c55e",tags:["다이어트 2530 여성","자취 1인가구","운동 직장인","건강식 탐색자","직장인 점심 여성 82.6%","프로틴 피로 남성 60.8%","혈당 관심층 +90%","육아맘"],ev:"여성 81.1% | 30대 31.6% · 25-29세 20.7% | '탱글 파스타' 연 70,080회 | '직장인 점심 도시락' 여성 82.6% · 30대 35.9% | '프로틴 간식' 남성 60.8% · 30대 44.6% — 남성 세그먼트 | '혈당스파이크' 37,576/mo -18% 피크 후 안정화 — 여전히 최대 키워드 | '아이 간식' 3,376/mo — 육아맘 세그먼트"},
