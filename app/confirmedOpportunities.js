...
export const confirmedOpportunities = {
  ...
  "tgl": [
    ...
    // ── 신규 확인된 기회 3개 (캠페인 확장) ──
    {
      ...
      when:"다이어트 중 파스타 갈망",
      keyword:"다이어트 파스타",volume:9980,verified:true,
    ...
    },
    {
      ...
      when:"점심시간 메뉴 고민",
      keyword:"직장인 점심 도시락",volume:2450,verified:true,
    ...
    },
    {
      ...
      keyword:"단백질 간식",volume:5723,verified:true,
    ...
    // ── Meal-prep 식단 준비 (NEW) ──
    {
      ...
      keyword:"밀프랩",volume:20013,verified:true,
    ...
    // ── 혈당스파이크 대안 (Section 10) ──
    {
      ...
      keyword:"혈당스파이크",volume:37576,verified:true,
    ...
    // ── 키즈 건강 면 (Section 12) ──
    {
      ...
      keyword:"아이 간식",volume:3376,verified:true,
