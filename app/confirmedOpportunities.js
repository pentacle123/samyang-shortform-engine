...
export const confirmedOpportunities = {
  ...
  "tgl": [
    ...
    // ── Meal-prep 식단 준비 (NEW) ──
    {
      ...
      keyword:"밀프렙",volume:17216,verified:true,
      funnelStage:"고려→Trial",funnelKPI:"댓글 참여 + 공유율",seasonPeak:"1~3월, 9월 (신년+가을 식단)",
      pathfinder:"'밀프렙' → '다이어트 밀프렙' → '단백질 도시락' 구매 경로. 다이어트 밀프렙 +42% 급성장",
      shortformIdea:"일요일 밀프렙에 탱글 3개만 넣어두면 주중 점심 해결",
      relatedVolume:{"다이어트 밀프렙":5563,"단백질 도시락":7726,"식단 도시락":4076,"일주일 식단":3443,"일주일 도시락":710},
      demo:"여성 74~92%, 30대 38~45% — 탱글 핵심 타겟 정중앙",
      reason:"가장 큰 규모의 새 오케이션 (38,734/mo). 밀프렙 문화에 탱글이 자연스럽게 포함되는 루틴 형성",
